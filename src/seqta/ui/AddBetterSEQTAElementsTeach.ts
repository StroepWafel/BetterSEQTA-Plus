...
async function createTeachHomeButton() {
  ...
  const homeButton = stringToHTML(
    /* html */`<a href="/betterseqta-home" id="betterseqta-teach-homebutton" data-betterseqta="true" class="tooltip betterseqta-spine-ctrl">
      <svg viewBox="0 0 495.398 495.398" fill="currentColor">
...
async function createTeachSettingsButton() {
  ...
  let SettingsButton = stringToHTML(/* html */ `
    <a href="#" id="AddedSettings" data-betterseqta="true" class="tooltip betterseqta-spine-ctrl">
...
async function addDarkLightToggleTeach() {
  ...
  const LightDarkModeButton = stringToHTML(/* html */ `
    <a href="#" id="LightDarkModeButton" data-betterseqta="true" class="DarkLightButton tooltip betterseqta-spine-ctrl">
